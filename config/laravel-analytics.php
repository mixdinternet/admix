...
return
    ...
    [
         ...
         */
        'certificatePath' => storage_path('laravel-analytics/') . env('ANALYTICS_P12'), #storage_path('laravel-analytics/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx-privatekey.p12'),
